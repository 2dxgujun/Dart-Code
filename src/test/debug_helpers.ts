...
export function createDebugClient(debugType: DebuggerType) {
	...
	const dc = process.env.DART_CODE_USE_DEBUG_SERVERS
		? new DartDebugClient(extApi.logger, { port: debugAdapterPort }, extApi.debugCommands, extApi.testCoordinator)
		: new DartDebugClient(extApi.logger, { runtime: "node", executable: debuggerExecutablePath, args: debuggerArgs }, extApi.debugCommands, extApi.testCoordinator);
